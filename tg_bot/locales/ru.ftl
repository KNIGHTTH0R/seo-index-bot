...
suma_to_deposit = Введите сколько монет вы хотите пополнить. 1 монета = $0.20
...
pay_message =
    ...
    Количество полученных монет: 1 монета = $0.20
...
amount_less_35 = Сумма не может быть меньше 35 монет для оплаты криптовалютой
