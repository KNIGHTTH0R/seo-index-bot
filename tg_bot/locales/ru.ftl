...
success_payment = Спасибо за оплату! Ваши деньги {$tx.tokens_num} зачислены в ваш аккаунт!

confirmed_by_payment = Ваш платеж подтвержден. На ваш счет добавлено {$tx.amount} $
