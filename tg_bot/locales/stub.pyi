...
https://www.youtube.com"""]: ...
    ...
    @staticmethod
    def message_confirm() -> Literal["""Посилання індексуються, очікуйте завершення індексації від кількох годин до кількох днів"""]: ...

    @staticmethod
    def not_enough_balance() -> Literal["""Недостатньо грошей на рахунку. Будь ласка, поповніть баланс"""]: ...
...
Посилання на оплату: { $link }"""]: ...
    ...
    @staticmethod
    def suma_to_deposit() -> Literal["""Введіть суму для поповнення. 1 посилання = $0.20"""]: ...

    @staticmethod
    def pre_confirm_text(*, count, usdt_amount) -> Literal["""Кількість посилань: { $count }
До сплати: { $usdt_amount } $"""]: ...
    ...
    @staticmethod
    def pay_message(*, usd_amount, link) -> Literal["""Сума до сплати: { $usd_amount }$
Посилання на оплату: { $link }"""]: ...
    ...
    @staticmethod
    def enter_deposit_amount() -> Literal["""Введіть суму в $ для поповнення"""]: ...
...
💰 Сума: &lt;code&gt;{ $crypto_amount }&lt;/code&gt;"""]: ...
    ...
    @staticmethod
    def amount_less_35() -> Literal["""Сума не може бути менше 7$ для оплати криптовалютою"""]: ...

    @staticmethod
    def min_deposit() -> Literal["""Сумма не може бути менше ніж 7$"""]: ...
